    ...
    <img src="image/add-button.png" alt="" width="16" height="16" border="0"  />Add new</a>	
    </p>
        ...
        <thead>
			...
			<tr>
              ...
              <td align='center' class='columnfunction'>
                        ...
                        <img src="image/update-button.png" width="16" height="16" border='0' />
                        </a>
                        </td>
                        <td align='center' class='columnfunction'>
                        <a href="?page=product_management&&function=del&&id=<?php echo $row["Product_ID"] ?>" onclick="return deleteConfirm()">
                        <img src="image/delete-button.png" width="16" height="16" border='0' />
                        </a>
                        </td>
            </tr>
            <?php
