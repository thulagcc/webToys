...
if(isset($_POST['btnRegister'])){
    ...
    if(strlen($pass1)<=5)
    {
        $err.="<li>Passowrd must be greater than 5 chars</li>";
    }
...
?>
        <h1>Member Registration</h1>
                 ...
                 <div class="form-group">
                            ...
                            <label for="txtTen" class="col-sm-1 control-label">Username:  </label>
							<div class="col-sm-10">
                       ...
                       <div class="form-group"> 
                            <label for="" class="col-sm-1 control-label">Confirm Password:  </label>
							<div class="col-sm-10">
                       ...
                       <div class="form-group">                               
                            <label for="lblFullName" class="col-sm-1 control-label">Full name:  </label>
							<div class="col-sm-10">
                       ...
                       <div class="form-group">      
                            <label for="lblEmail" class="col-sm-1 control-label">Email:  </label>
							<div class="col-sm-10">
                        ...
                        <div class="form-group">   
                             <label for="lblDiaChi" class="col-sm-1 control-label">Address:  </label>
							<div class="col-sm-10">
                         ...
                         <div class="form-group">  
                            <label for="lblPhone" class="col-sm-1 control-label">Telephone:  </label>
							<div class="col-sm-10">
                          ...
                          <div class="form-group">  
                            <label for="lblHender" class="col-sm-1 control-label">Gender:  </label>
							<div class="col-sm-10">                              
                          ...
                          <div class="form-group"> 
                            <label for="lblYourBirth" class="col-sm-1 control-label">Date of Birth:  </label>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
						      <input type="submit"  class="btn btn-warning" style="color:black" name="btnRegister" id="btnRegister" value="Register"/>
						</div>
                     </div>
				</form>
</div>
